...
/**
 * @title IncentivizedERC20Upgradeable
 * @author alvin@yolo.wtf
 * @notice Upgradeable base ERC20 implementation with incentive mechanics for YOLO Protocol
 * @dev Inspired by Aave's implementation, optimized for YOLO's architecture and proxy pattern
 */
abstract contract IncentivizedERC20Upgradeable is Initializable, ContextUpgradeable, IERC20, IERC20Metadata {
    ...
    // Storage reference (instead of immutable)
    IACLManager public ACL_MANAGER;
    ...
    /**
     * @dev Initializes the token with metadata and ACL manager
    ...
    /**
     * @notice Approve spender to spend amount of msg.sender's tokens
     * @param spender The spender address
    ...
    /**
     * @notice Updates the incentives tracker
     * @dev Only callable by incentives admin
     * @param newTracker The new incentives tracker address
     */
    function setIncentivesTracker(IIncentivesTracker newTracker) external virtual onlyIncentivesAdmin {
    ...
    /**
     * @notice Returns the current incentives tracker
     */
    ...
    /**
     * @dev Spend allowance with underflow protection
     * @param owner The owner address
     * @param spender The spender address
